...
class ViewController: UITableViewController{
    ...
    override func viewDidLoad()
    {
        ...
        let colors = [UIColor(red: 147.0/255, green: 193.0/255, blue: 207.0/255, alpha: 1.0),
                      UIColor(red: 139.0/255, green: 120.0/255, blue: 186.0/255, alpha: 1.0)]
        let color = UIColor(gradientStyle: .topToBottom, withFrame: self.view.frame, andColors: colors)
        self.view.superview?.backgroundColor = color
    }
    ...
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath)
    {
        ...
        if activeCellRow > -1
        {
            UIView.animate(withDuration: 0.5, delay: 0, options: .curveEaseOut, animations: { () -> Void in
                cell.quizTopBlackMask.alpha = 0.8
            }, completion: nil)
        }
        else
        {
    ...
    func animateCell(tableView:UITableView, cell:FoldingCell, row:Int)
    {
        ...
        if cellHeights[row] == kCloseCellHeight
        {
            ...
            let colors = [UIColor(red: 139.0/255, green: 120.0/255, blue: 186.0/255, alpha: 1.0),
                          UIColor(red: 147.0/255, green: 193.0/255, blue: 207.0/255, alpha: 1.0)]
            let color = UIColor(gradientStyle: .radial, withFrame: self.view.frame, andColors: colors)
